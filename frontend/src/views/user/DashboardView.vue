  ...
  <AppLayout>
    <div class="space-y-6">
      ...
      <template v-else-if="stats">
        <UserDashboardModelCatalog :total-keys="stats.total_api_keys || 0" />
...
import UserDashboardModelCatalog from '@/components/user/dashboard/UserDashboardModelCatalog.vue'
