<template>
  <div class="card">
    ...
    <div class="space-y-3 p-4">
      <button @click="router.push('/keys')" class="group flex min-h-11 w-full cursor-pointer items-center gap-3 rounded-lg p-3 text-left transition-colors duration-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500/40 dark:hover:bg-dark-800">
      ...
      <button @click="router.push('/usage')" class="group flex min-h-11 w-full cursor-pointer items-center gap-3 rounded-lg p-3 text-left transition-colors duration-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500/40 dark:hover:bg-dark-800">
      ...
      <button v-if="canUseBatchImage" @click="router.push('/batch-image')" class="group flex min-h-11 w-full cursor-pointer items-center gap-3 rounded-lg p-3 text-left transition-colors duration-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500/40 dark:hover:bg-dark-800">
      ...
      <button @click="router.push('/redeem')" class="group flex min-h-11 w-full cursor-pointer items-center gap-3 rounded-lg p-3 text-left transition-colors duration-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary-500/40 dark:hover:bg-dark-800">
