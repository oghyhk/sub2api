export default {
    accounts: {
      ...
      usageWindow: {
        ...
        gemini3Pro: 'Pro',
        gemini3ProHint: 'Gemini Pro quota pool',
        gemini3Flash: 'Flash',
        gemini3FlashHint: 'Gemini Flash quota pool',
        gemini3Image: 'Image',
        gemini3ImageHint: 'Gemini image-generation quota pool',
        claude: 'Claude',
        claudeHint: 'Claude quota pool provided through Google Antigravity',
        grokRequests: 'Req',
        grokTokens: 'Tok',
