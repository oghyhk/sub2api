export default {
  ...
  keys: {
    ...
    useKey: 'Set Up',
    useKeyModal: {
      title: 'Set Up a Coding Tool',
      description: 'Choose this computer and your coding tool. We will prepare the exact setup for both you and a coding agent.',
      osStep: '1. Choose this computer\'s operating system',
      clientStep: '2. Choose your coding tool',
      handoffTitle: '3. Copy one complete setup instruction',
      handoffDescription: 'Follow it yourself, or paste it into a coding agent and ask the agent to complete the setup on this computer.',
      setupInstruction: 'Setup instruction',
      copyInstruction: 'Copy setup instruction',
      copiedInstruction: 'Instruction copied',
      secretWarning: 'This instruction contains your API key. Paste it only into a coding agent you trust, and never commit it to a repository.',
      manualTitle: 'Configuration details',
      promptIntro: 'Set up {client} on {os} to use my Sub2API account.',
      promptRequirements: 'Connection details',
      promptApiBase: 'API base URL',
      promptApiKey: 'API key',
      promptDefaultModel: 'Default model',
      promptAvailableModels: 'Available models',
      promptRules: 'Setup requirements',
      promptRuleBackup: 'Back up any existing configuration before editing it, and merge unrelated existing settings instead of overwriting them.',
      promptRuleDirectories: 'Create missing parent directories and use the OS-specific paths below.',
      promptRuleSecret: 'Keep the API key private. Do not print it in logs or commit it to a repository.',
      promptConfiguration: 'Apply this configuration',
      promptFile: 'FILE',
      promptCommand: 'RUN',
      promptFinish: 'After setup, fully restart the coding tool, send a short test prompt, and report which files were changed and whether the test succeeded.',
      copy: 'Copy',
      copied: 'Copied',
      ...
      openai: {
        description: 'Configure Codex with the supported GPT-5.6 models through this API key.',
      ...
      gemini: {
        ...
        modelComment: 'Default fast model; use gemini-3.1-pro for complex work',
        note: 'These environment variables will be active in the current terminal session. For permanent configuration, add them to ~/.bashrc, ~/.zshrc, or the appropriate configuration file.',
      },
      grok: {
      ...
      opencode: {
        ...
        description: 'Configure OpenCode with all five supported GPT and Gemini models through this API key.',
        hint: 'User-level OpenCode configuration. Back up and merge an existing file instead of replacing unrelated providers. Restart OpenCode after saving.',
      },
    },
